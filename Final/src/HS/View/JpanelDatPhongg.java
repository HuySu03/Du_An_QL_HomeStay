 ...
 * @author Admin
 */
public class JpanelDatPhongg extends javax.swing.JPanel {
private Repo_Ds_Phong repo = new Repo_Ds_Phong();
    private DefaultTableModel mol = new DefaultTableModel();
    private int index = -1;
    private View_Main mainForm;

    public JpanelDatPhongg(View_Main mainForm) {
        this.mainForm = mainForm;  // Lưu tham chiếu đến form chính
        initComponents();
        initPhong();
    }
   ...
   public void initPhong() {
    ...
    ArrayList<Model_Phong> listPhong = repo.getAll();

    // Tạo các JPanel để chứa các chi tiết phòng
    ArrayList<JPanel> panelList = new ArrayList<>();
    panelList.add(JpanelPhong1);
    panelList.add(JpanelPhong2);
    panelList.add(JpanelPhong3);
    panelList.add(JpanelPhong4);
    panelList.add(JpanelPhong5);
    panelList.add(JpanelPhong6);
    panelList.add(JpanelPhong7);
    panelList.add(JpanelPhong8);
    panelList.add(JpanelPhong9);
    panelList.add(JpanelPhong10);
    panelList.add(JpanelPhong11);
    panelList.add(JpanelPhong12);
    panelList.add(JpanelPhong13);
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1134, Short.MAX_VALUE)
