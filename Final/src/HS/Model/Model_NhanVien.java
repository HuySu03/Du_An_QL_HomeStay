...
public class Model_NhanVien {
    ...
    public Model_NhanVien(String id_nv, String ho_ten, String sdt, String email, String dia_chi, String tai_khoan, String mat_khau, String cccd, boolean gioitinh, int tuoi) {
        this.id_nv = id_nv;
        this.ho_ten = ho_ten;
        this.sdt = sdt;
        this.email = email;
