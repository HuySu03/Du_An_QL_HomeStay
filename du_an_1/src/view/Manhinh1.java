 ...
 * @author Admin
 */
public class Manhinh1 extends javax.swing.JDialog {
     void init()
          {
     ...
     */
     public Manhinh1(java.awt.Frame parent,boolean modal) {
        super(parent,modal);
    initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manhinh1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                  new Manhinh1(new JFrame(), true).setVisible(true);
            }
        });
    }
