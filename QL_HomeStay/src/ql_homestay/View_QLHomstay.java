 ...
 * @author HuySu
 */
public class View_QLHomstay extends javax.swing.JFrame {

    /**
     * Creates new form Main
     */
    public View_QLHomstay() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btn_test1.setText("jButton1");

        btn_test2.setText("jButton1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_QLHomstay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_QLHomstay().setVisible(true);
            }
        });
    }
